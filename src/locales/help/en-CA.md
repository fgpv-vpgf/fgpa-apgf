...
It only works with esriImage and esriTile layers.
...
The plus button at the top of the extent list lets you set the extent dynamically

ID
The id of the extent set.
...
selecting a bounding box extent or a whole extent set.
...
maps displayed.  Use the plus button to dynamically set the values for the level, resolution or scale.
