...
Cette bibliothèque permet de génèré des formulaires à partir de schémas en format JSON en utilisant AngularJS. L'outil APGF
...
à l'application APGF et pourrait ne pas être disponibles pour tous les utilisateurs.
