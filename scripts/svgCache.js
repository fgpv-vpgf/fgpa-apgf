const iconCache = [
    { file: 'src/content/images/iconsets/default-icons.svg', prefix: 'default', icons: 'check northarrow'.split(' '), isDefault: true },
    ...
    { file: 'src/content/images/iconsets/content-icons.svg', prefix: 'content', icons: 'create add remove save'.split(' ') },
    { file: 'src/content/images/iconsets/editor-icons.svg', prefix: 'editor', icons: 'insert_drive_file drag_handle'.split(' ') },
    { file: 'src/content/images/iconsets/file-icons.svg', prefix: 'file', icons: 'file_upload cloud cloud_download'.split(' ') },
